% -----------------------------------------------------------------
%  Main_Truss37_MassMin_FrequencyBounds_SQP.m
% -----------------------------------------------------------------
...
%  truss structure using sequential quadratic programming.
% -----------------------------------------------------------------

clc; clear; close all;

disp(' ------------------------------------------ ')
disp(' Main_Truss37_MassMin_FrequencyBounds_SQP.m ')
disp(' ------------------------------------------ ')
...
fprintf('\n  Original truss mass (kg): %5.2f',fun(x0));
fprintf('\n Optimized truss mass (kg): %5.2f',Fopt   );
disp(' ')

% plot the nominal truss structure
PlotTruss37([x0(1:NvarsA)*5e3 x0(NvarsA+1:end)],MyTruss,'Non-optimal Truss Structure');
