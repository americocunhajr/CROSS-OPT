% -----------------------------------------------------------------
%  Main_Truss10_MassMin_FrequencyBounds_SQP.m
% -----------------------------------------------------------------
...
%  truss structure using using sequential quadratic programming.
% -----------------------------------------------------------------

clc; clear; close all;

disp(' ------------------------------------------ ')
disp(' Main_Truss10_MassMin_FrequencyBounds_SQP.m ')
disp(' ------------------------------------------ ')
...
PlotTruss10( x0*400,MyTruss,'Non-optimal Truss Structure');
